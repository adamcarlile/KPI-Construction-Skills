class Image < ActiveRecord::Base
  ...
  attachment_options = {
    ...
    :styles => { 
      :course_thumb => "160x125#",
      :course_promo => "690x200#",
      :thumb   => "80x80#", 
      :small   => ">100x100#",
      :medium  => "140x140>",
      :large   => "290x290>",
  ...
  validates_attachment_content_type :file, :content_type => ['image/jpeg','image/pjpeg','image/gif', 'image/png', 'image/x-png']
